...
function ResetPasswordButton({email, token, newPassword, confirmPassword, setShowErrorMessage, setShowLoadingMessage, setErrorMessage, setShowSuccessMessage}) {
    const fetchData = async () => {
        const apiEndpoint = process.env.REACT_APP_apiHost + "/user/changePassword";
        console.log(email);
