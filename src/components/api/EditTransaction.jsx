...
function EditTransaction({ transactionData, setShowErrorMessage, setShowSuccessMessage, setShowLoadingMessage}) {
  // console.log(transactionData);
  const { transactionTitle, selectedCategory,
          description, selectedIconOption, selectedGroupOption, 
          splitAmount, selectCategoryName, selectedRecurringFrequency} = transactionData;
