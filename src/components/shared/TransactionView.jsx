...
function TransactionView({ userId, closePopup }) {
  ...
  //     setReceipts(data);
  //     setLoading(false);
  //     console.log("Receipts after editing:", receipts);
  //   } catch (error) {
  //     setLoading(false);
  //     console.error("Error fetching receipt data:", error);
  //     setError(error);
  ...
  return (
    <React.Fragment>
      ...
      <div className="section-container">
        <div class="section-header body-xlarge font-medium">
          Recent Transaction
        </div>
        <div headerName="Recent Transaction"></div>
        <div className="transactions-container">
          ...
          {receipts.length === 0 ? (
            ...
            receipts.map((receipt, index) => (
              <div
                className="transaction-container body-small font-small"
                key={index}
              >
                ...
                <div className="transaction-trans">
                  <div className="font-medium">
                    {new Date(receipt.created_datetime).toLocaleDateString(
                      "en-US",
                      {
                        weekday: "long",
                        year: "numeric",
                  ...
                  <div className="body-large font-large font-bold">
                    {receipt.title}
                  </div>
